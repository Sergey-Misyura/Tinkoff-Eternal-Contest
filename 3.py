...
if (floors[num-1] - floors[0] <= t) or (floors[-1] - floors[num-1] <= t):
    print(floors[-1] - floors[0])
else:
    if (floors[num-1] - floors[0]) < (floors[-1] - floors[num-1]):
        print(floors[num-1] - floors[0]+ floors[-1] - floors[0])
    else:
        print(floors[-1] - floors[num-1] + floors[-1] - floors[0])